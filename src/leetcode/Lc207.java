...
public class Lc207 {
    public static void main(String[] args) {
        ...
        System.out.println(new Solution207_2().canFinish(numCourses, prerequisites));
    }
}
...
class Solution207_3 {
    ...
    public boolean canFinish(int numCourses, int[][] prerequisites) {
        ...
        for (int[] course : prerequisites) {
            edge.get(course[1]).add(course[0]);
        }
    ...
    private void dfs(List<List<Integer>> edge, int u, int[] visited) {
        visited[u] = 1;
